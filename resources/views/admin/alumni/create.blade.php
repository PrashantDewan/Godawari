                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('alumni_name') is-invalid @enderror"
                                    name="alumni_name" value="{{ old('alumni_name') }}" placeholder="Enter Alumni Name">
                                @error('alumni_name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('batch') is-invalid @enderror"
                                    name="batch" value="{{ old('batch') }}" placeholder="Enter Alumni Batch">
                                @error('batch')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea type="test"
                                    ...
                                    placeholder="Enter Testimonial">{{ old('alumni_testimonial') }}</textarea>
